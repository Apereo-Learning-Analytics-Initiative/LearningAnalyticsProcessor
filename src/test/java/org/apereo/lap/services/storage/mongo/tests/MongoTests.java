...
import org.apereo.lap.services.storage.mongo.MongoMultiTenantConfiguration;
...
@SpringApplicationConfiguration(classes = {LearningAnalyticsProcessor.class, MongoMultiTenantConfiguration.class})
