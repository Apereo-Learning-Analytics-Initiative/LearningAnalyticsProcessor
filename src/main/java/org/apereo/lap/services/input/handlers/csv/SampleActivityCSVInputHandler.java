...
public class SampleActivityCSVInputHandler extends ActivityCSVInputHandler {

    public SampleActivityCSVInputHandler(ConfigurationService configuration, JdbcTemplate jdbcTemplate) {
