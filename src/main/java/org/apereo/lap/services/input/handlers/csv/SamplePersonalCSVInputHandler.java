...
public class SamplePersonalCSVInputHandler extends PersonalCSVInputHandler {

    public SamplePersonalCSVInputHandler(ConfigurationService configuration, JdbcTemplate jdbcTemplate) {
