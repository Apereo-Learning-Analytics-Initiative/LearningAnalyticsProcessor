...
1) PERSONAL (Student Demographics Data)
...
SAT verbal score        The numeric SAT verbal score.
SAT Math score          The numeric SAT mathematics score.
ACT_Composite score     The ACT score of the Student (Either of the scores will be reported by the students)
...
Full/Part-time Status   Code for full-time or part-time student based on the number of credit hours currently enrolled.
Class                   The current academic standing of the student as expressed by the number of semesters of completed coursework
Hours Earned            The total number of hours earned by each of the student
Cumulative GPA          Cumulative university grade point average (four point scale).
Semester GPA            Semester university grade point average (four point scale).
Academic Standing       Current university standing such as probation, dean’s list, or semester honors.


2) COURSES (Course Data)
   The course data has all the details of the course that the students are enrolled in

COURSE                  The course number of the course.
ALTERNATIVE_ID          The CWID of the student replaced with some unique identifiers for security reasons.
ENROLLMENT              The number of students in the course/ section
FINAL_GRADE             The final course grade of the Student.
                        Entries are A,A-,B+, B,B-,C+, C,C-, D,F, I, or W.
                        If the student drops the course within the official drop/add window, the course grade field will be null.


3) GRADES (LMS Gradebook Data)
...
DATE                    To facilitate chronological division of gradebook. Helpful in breaking down the gradebook like 4 weeks or 8 weeks into the course during testing phases.


4) EVENTS (LMS Usage Data)
   The LMS Events table had details of the events generated for each of the tool usage by the students namely,

ALTERNATIVE_ID          The CWID of the student replaced with some unique identifiers for security reasons.
COURSE                  The course number of the course.
EVENT                   The name of the event that was generated
EVENTDATE               The date when the event occured
